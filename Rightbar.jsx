            ...
            <div className="rightbarWrapper">
                ...
                <div className="mainList">
                    <li className="sidebarListItem">
                        <div className="title">
                            <div className="sidebarIcon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-capsule" viewBox="0 0 16 16">
                    ...
                    <li className="sidebarListItem">
                        <div className="title">
                            <div className="sidebarIcon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-clipboard2-pulse-fill" viewBox="0 0 16 16">
